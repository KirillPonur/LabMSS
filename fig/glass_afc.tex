...
\pgfplotstableset{
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=1pt, mark size=1.2pt, solid,draw=darkblue] plot [error bars/.cd, y dir = both, y explicit,x dir = both, x explicit] table [ x=f_Hz, y=U_mV] {../data/glass.tsv};
